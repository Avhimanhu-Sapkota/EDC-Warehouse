<?php
    ...
    if (isset($_POST['sub_button'])){
        ...
        $conf_password=mysqli_real_escape_string($_POST['password2']);
        ...
        $conf_password=trim($_POST['password2']);
...
<html lang="en">
    ...
    <head>
        ...
        <!--Title of the page-->
        <title> Sign Up - EDC Warehouse </title>
    ...
    <body>
        ...
        <form method="post" action="signup.php" class="sign-up-form"> 
            <table id="form-table">
                ...
                <tr class="table-row">
                    <td> AGE GROUP : </td>
                    <td><select name="agegroup" class="textInput" required>
                ...
                <tr>
                    <td colspan="2" style="text-align:center" required> 
                        <input type="checkbox" name="terms"> Accept terms and contiditions. </td>
                </tr>
                <tr>
                    <td> </td>
                    <td>
                ...
                <tr class="table-row">
                    <td colspan="2" style="text-align:center"><input type="submit" name="sub_button" value="Sign Up" class="button"> </td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align:center">Already have an account? <a href="login.php">Login Here</a> </td>
                </tr>
            </table>
        </form>
        <div class="empty-box"></div>    
